...
export default class GooglePlacesAutocomplete extends Component {
  ...
  _getFlatList = () => {
    ...
    if ((this.state.text !== '' || this.props.predefinedPlaces.length || this.props.currentLocation === true) && this.state.listViewDisplayed === true) {
      return this.state.dataSource.map((val) => {
        //console.log('val', val)
        return this._renderRow(val)
      })
      // return (
      //   <FlatList
  ...
  render() {
    ...
    //console.log('autoListStyle', this.props.textInputProps)
    ...
    return (
      ...
      >
        ...
        {this.state.listViewDisplayed && autoListStyle && this._isMounted === true ? 
          <View  style={autoListStyle}>
            {this._getFlatList()}
          </View> 
          : this._getFlatList()
        }
